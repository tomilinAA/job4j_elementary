...
public class ConverterTest {
    ...
    public void whenConvert140RblThen2Dollar() {
                float in1 = 140;
                float expected1 = 2;
                float out1 = ru.job4j.converter.Converter.rubleToEuro(in1);
                float eps1 = 0.0001f;
    ...
    public void whenConvert140RblThen2Yuan() {
        float in2 = 140;
        float expected2 = 2;
        float out2 = ru.job4j.converter.Converter.rubleToEuro(in2);
        float eps2 = 0.0001f;
    ...
    public void whenConvert140RblThen2Tugriki() {
        float in3 = 140;
        float expected3 = 2;
        float out3 = ru.job4j.converter.Converter.rubleToEuro(in3);
        float eps3 = 0.0001f;
